...
router.get('/inventory/create', inventoryitem_controller.inventoryitem_create_get);

//POST request for creating a inventory item
router.post('/inventory/create', inventoryitem_controller.inventoryitem_create_post);

//GET request to delete a inventory item
router.get('/inventory/:id/delete', inventoryitem_controller.inventoryitem_delete_get);

//POST request to delete a inventory item
router.post('/inventory/:id/delete', inventoryitem_controller.inventoryitem_delete_post);

//GET request to update a inventory item
router.get('/inventory/:id/update', inventoryitem_controller.inventoryitem_update_get);

//POST request to update a inventory item
router.post('/inventory/:id/update', inventoryitem_controller.inventoryitem_update_post);

//GET request for one inventory item
router.get('/inventory/:id', inventoryitem_controller.inventoryitem_detail)
